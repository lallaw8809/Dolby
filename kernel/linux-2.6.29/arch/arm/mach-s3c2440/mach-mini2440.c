...
#define MINI2440_GPIO_LED1 S3C2410_GPB5
...
if ((gpio_request(MINI2440_GPIO_LED1, "MINI2440_GPIO_LED1") == 0) &&
	    (gpio_direction_output(MINI2440_GPIO_LED1, 0) == 0)){
		gpio_export(MINI2440_GPIO_LED1, 0);
		gpio_set_value(MINI2440_GPIO_LED1, 0);
	}else
		printk(KERN_ERR "could not obtain gpio for MINI2440_GPIO_LED1\n");
}
